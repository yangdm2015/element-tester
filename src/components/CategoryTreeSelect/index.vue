...
export default {
    ...
    methods: {
        selectedNodesChange(nodes){
            this.$emit('selected-nodes-change',nodes)
        },
        getAllCategoryList() {
            ...
            this.$post(url, body)
                .then(data => {
                    this.categoryList =
                        data && data.length ? parseCategoryName(data) : [];
                })
                .catch(err => {
                    console.warn(err);
        ...
        getCategoryByLevel() {
            return new Promise(resolve => {
                this.categoryData = categoryData = parseCategoryName(data);
                resolve(data);
            });
